...
def get_wx_article(biz, uin, key, count=10):
    offset=1+(index+1)*11
    params={
        '__biz':biz,
        'uin':uin,
        ...
        'action':'getmsg',
        'f':'json',
        'pass_ticket':'haTp/uxAvK6S4PyD2Vy3CJNGjC17qUsEFNGh6aBl4Dac2VBOS0qv8bLEPj+ckE8m',
        'scene':124,
        'is_ok':1,
        'appmsg_token':'1016_DCj%2Bn0mSBMHcXTFWuRccLnEJTBvaFcz0MWozQQ~~',
        'x5':0,
    }
...
if __name__ == '__main__':
    biz = 'MzIwNDI1NjUxMg=='
    uin = 'MTY1NTcyMDYxMg=='
    key = '4af267131119af888dfd338094ba8aa1afba149aadd84f9adb525d84ab5afbd3bbf4289e2fad9ef2fc29954c3de21074b0116fd47fdcc67c1dd905a0e2ff6942b0544ff041ac366c08e1a53247b4fd57'
    index = -1
    while 1:
