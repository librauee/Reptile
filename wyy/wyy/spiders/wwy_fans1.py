...
class WyyFansSpider(scrapy.Spider):
    ...
    def parse2(self, response):
        ...
        fans = WyyItem()
        try:
            fans['total_record_count'] = len(json1['allData'])
            fans['week_record_count'] = len(json1['weekData'])
        except:
            fans['total_record_count'] = 'secret'
            fans['week_record_count'] = 'secret'

        fans['avatar'] = response.meta['avatar']
        fans['userId'] = response.meta['userId']
        fans['vipRights'] = response.meta['vipRights']
        fans['gender'] = response.meta['gender']
        fans['eventCount'] = response.meta['eventCount']
        fans['fan_followeds'] = response.meta['followeds']
        fans['fan_follows'] = response.meta['follows']
        fans['signature'] = response.meta['signature']
        fans['time'] = response.meta['time']
        fans['nickname'] = response.meta['nickname']
        fans['playlistCount'] = response.meta['playlistCount']
        yield fans